        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <p className="text-slate-600 font-bold text-base md:text-lg max-w-xl mx-auto lg:mx-0 leading-relaxed mb-8">
              دروس، ملخصات، ومقارنات ذكية مصممة خصيصاً باش تفهم المقررات ديالك بلا تعقيد، وتوجد للامتحانات ديالك بثقة كاملة.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
              ...
              <div className="flex items-center gap-3 px-6 py-4 bg-white border border-slate-200 rounded-2xl shadow-xs">
                ...
                <span className="text-xs font-black text-slate-700">برنامج TSGE كامل 100%</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-12 pt-8 border-t border-slate-200/80 text-center lg:text-right">
              <div>
                <span className="block text-2xl font-black text-slate-900">14+</span>
                <span className="text-xs font-bold text-slate-500">موديل دراسي</span>
              </div>
              <div>
                <span className="block text-2xl font-black text-slate-900">100%</span>
                <span className="text-xs font-bold text-slate-500">تفاعل ووضوح</span>
              </div>
              <div>
                <span className="block text-2xl font-black text-slate-900">49 DH</span>
                <span className="text-xs font-bold text-slate-500">لكل موديل</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-full max-w-md">
              ...
              <img 
                src={homeImg} 
                alt="RR Gestion Home" 
                className="w-full h-auto object-cover rounded-[3rem] shadow-2xl border-4 border-white"
              />
            </div>
          </motion.div>
