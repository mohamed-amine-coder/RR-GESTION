        ...
        >
            ...
            <div className="bg-gradient-to-br from-amber-50/60 to-teal-50/40 border-2 border-teal-500 rounded-2xl p-4 md:p-6 shadow-sm">
              ...
              <div className="divide-y divide-teal-100/60">
                {current.terms.map((t, idx) => (
                  <div key={idx} className="py-2 flex items-center justify-center px-1 gap-3">
                    <span dir="auto" className="font-black text-teal-600 text-sm md:text-base text-center flex-1">
                      {t.ar}
                    </span>
                    <ArrowLeftRight className="w-3.5 h-3.5 text-teal-300 shrink-0" />
                    <span dir="ltr" className="font-extrabold text-slate-800 text-sm md:text-base text-center flex-1">
                      {t.fr}
                    </span>
                  </div>
                ))}
          ...
          {current.type === 'trap' && (
            <div className="bg-gradient-to-br from-amber-50/60 to-rose-50/50 border-2 border-rose-400 rounded-2xl p-5 md:p-7 text-center shadow-sm">
              ...
              <p dir="auto" className="text-slate-800 font-black text-sm md:text-base leading-relaxed max-w-lg mx-auto">
                {current.text}
              </p>
            </div>
          )}
          ...
          {current.type === 'quiz' && (
            <div className="bg-gradient-to-br from-amber-50/60 to-white border-2 border-slate-200 rounded-2xl p-4 md:p-6 shadow-sm text-center">
              <h3 dir="auto" className="text-sm md:text-base font-black text-slate-900 mb-3 leading-relaxed">
                {current.question}
              </h3>
